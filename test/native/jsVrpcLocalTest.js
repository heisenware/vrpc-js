...
const { VrpcCaller, VrpcAdapter } = require('../../../index')
...
describe('An instance of the VrpcCaller class', () => {
  let vrpc
  it('should be construct-able given a node.js VrpcAdapter', () => {
    vrpc = new VrpcCaller(VrpcAdapter)
    assert.ok(vrpc)
  })
  describe('The corresponding VrpcCaller instance', () => {
    let testClass
