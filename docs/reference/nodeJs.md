...
| options.domain | <code>String</code> |  | Sets default domain |
...
| [options.bestEffort] | <code>String</code> | <code>false</code> | If true, message will be sent with best effort, i.e. no caching if offline |
